...
点击工具栏的“导出图片”会下载一张完整对阵图 PNG。导出使用对阵图画布的完整尺寸，不受当前浏览器窗口、拖拽位置或缩放比例影响。图片底部会带上 `worldcup.inathan.wang`、`© 2026 iNathan 版权所有`、生成时间和数据快照日期。
